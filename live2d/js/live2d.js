        ...
        function() {
            ...
            N.prototype.add = function(t) {
                if (this._$P.length <= this.size) {
                    ...
                    x._$jT(this._$P, 0, i, 0, this.size),
                    this._$P = i
                }
            ...
            N.prototype._$BL = function() {
                ...
                return x._$jT(this._$P, 0, t, 0, this.size),
                t
            },
            B._$Fr = 0,
            B._$hs = 1,
            ...
            Y.prototype._$UT = function(t, i) {
                ...
                return x._$jT(t, 0, e, 0, t.length),
                e
            },
            ...
            V.prototype._$7T = function(t) {
                var i, e = x.getUserTimeMSec(),
                r = 0;
                switch (this._$_L) {
                case STATE_CLOSING:
                    r = (e - this._$bb) / this._$Dr,
                    r >= 1 && (r = 1, this._$_L = xt.STATE_CLOSED, this._$bb = e),
                    i = 1 - r;
                    break;
                case STATE_CLOSED:
                ...
                case STATE_OPENING:
                    ...
                    r >= 1 && (r = 1, this._$_L = xt.STATE_INTERVAL, this._$12 = this._$T2()),
                    i = r;
                    break;
                case STATE_INTERVAL:
                    this._$12 < e && (this._$_L = xt.STATE_CLOSING, this._$bb = e),
                    i = 1;
                    break;
                case STATE_FIRST:
                default:
            ...
            X.prototype._$nS = function(t) {
                ...
                e = new Int32Array(i);
                x._$jT(this._$sb, 0, e, 0, this._$sb.length),
                this._$sb = e;
                var r = new Array;
                x._$jT(this._$U2, 0, r, 0, this._$U2.length),
                this._$U2 = r
            },
            z.prototype = new I,
                ...
                T = o; T < u; T += n) {
                    ...
                    if (v = i[T], L = i[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
                        ...
                        if ( - 2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
                            ...
                            B = .5 * (v - -2),
                            U = .5 * (L - -2);
                            B + U <= 1 ? (e[T] = C + (b - C) * B + (D - C) * U, e[T + 1] = N + (F - N) * B + (R - N) * U) : (e[T] = w + (D - w) * (1 - B) + (b - w) * (1 - U), e[T + 1] = O + (R - O) * (1 - B) + (F - O) * (1 - U))
                        } else if (L >= 1) {
                            var b = s[2 * (0 + a * M)],
                            F = s[2 * (0 + a * M) + 1],
                            C = p - 2 * c + 1 * g,
            ...
            nt.prototype.drawElements = function(t, i, e, r, o, n, s, a) {
                try {
                    ...
                    P = 0; P < h; P += 3) {
                        ...
                        x = p + c * e[2 * L],
                        w = f + d * e[2 * L + 1];
                        s && (s._$PS(M, E, T), M = T[0], E = T[1], s._$PS(A, I, T), A = T[0], I = T[1], s._$PS(x, w, T), x = T[0], w = T[1]);
                        var O = l * r[2 * S],
                        D = $ - $ * r[2 * S + 1],
                        R = l * r[2 * v],
                        b = $ - $ * r[2 * v + 1],
                        ...
                        if (n || (n = 1.2), at.IGNORE_EXPAND && (n = 0), at.USE_CACHED_POLYGON_IMAGE) {
                            ...
                            !it.gl_cacheImage[P]) {
                                ...
                                rt.translate( - Q, -Z),
                                nt.clip(rt, g, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
                                rt.drawImage(t, 0, 0),
                                it.gl_cacheImage[P] = {
                                    cacheCanvas: et,
                                    cacheContext: rt
                        ...
                        } else at.IGNORE_CLIP || nt.clip(u, g, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
            ...
            nt.expandClip = function(t, i, e, r, o, n, s, _, a, h) {
                ...
                C = h + f * v / L,
                N = nt._$50;
                return null != i._$P2(N) && (nt.clipWithTransform(t, N, M, E, A, I, x, w, O, D, F, C, R, b), !0)
            },
...
default = r;
    ...
    r.prototype.loadTexture = function(t, i, e, r) {
        let n = document.getElementById("tex");
        n.src = e;
        n.onload = function() {
...
default = r;
    ...
    r.prototype.loadModelSetting = function(t, i) {
        ...
        function(t) {
            var img=document.createElement("img"),r = String.fromCharCode.apply(null, new Uint8Array(t));
            e.json = JSON.parse(r),
			e.json.textures=[window.pio],
			/* change model */
            i()
        })
    },
